...
*/
 ...
 [BASE] = LAYOUT_60_ansi( /* Base */ /* HOME_A, HOME_S, HOME_D, HOME_F, KC_G, KC_H, HOME_J, HOME_K, HOME_L, HOME_SCLN,  */
    ...
    TO(FN1), HOME_A,    HOME_S,    HOME_D, HOME_F, KC_G, KC_H,   HOME_J, HOME_K, HOME_L,    HOME_SCLN,          KC_QUOT,          KC_ENT,
  ...
  * |-----------------------------------------------------------------------------------------+
  * | Tab    |  q  | BASE  |  VOLDN  |  VOLUP  |  t  |  y  |  u  |  i  |  o  | PS | HOME | END |   \    |
  * |-----------------------------------------------------------------------------------------+
 ...
 [FN1] = LAYOUT_60_ansi( /* FN1 */
    ...
    TO(FN2), _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_PGUP, KC_PGDN, _______,
 ...
 [FN2] = LAYOUT_60_ansi( /* FN2 KC_AP2_BT1, KC_AP2_BT2, KC_AP2_BT3, KC_AP2_BT4*/
    ...
    TO(FN1), _______,    _______,      _______,    _______,    _______, _______, _______, _______, _______, KC_PSCR, KC_HOME, KC_END,  _______,
    TO(BASE), KC_A,    KC_S,    KC_D,    KC_F,    _______, _______, KC_J, KC_K, KC_L, KC_PGUP, KC_PGDN, _______,
    _______,             _______,    _______,    _______,    _______, _______, _______, _______, _______, KC_INS,  KC_DEL,  _______,
